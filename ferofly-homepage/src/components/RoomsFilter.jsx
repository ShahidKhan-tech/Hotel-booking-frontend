            ...
            <div className="row">
                ...
                <div className="col-md-4 col-12 ml-auto">
                    ...
                    <div className="input-group my-5 ">
                        <label htmlFor="size" className="mr-4 pl-4">Room Size </label>
                        <DatePicker selected={new Date()} className="form-control"/>
                        <DatePicker selected={new Date()} className="form-control"/>
                        <input type="number" className="ml-2" name="minSize" id="size" value={minSize} onChange={handleChange} className="form-control" />
